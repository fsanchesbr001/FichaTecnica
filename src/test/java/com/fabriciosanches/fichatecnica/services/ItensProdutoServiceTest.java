...
class ItensProdutoServiceTest {
    ...
    void obterDescricoesUnidade_DeveMontarDescricaoComFallbacks() {
        UnidadeMedidaEntity u1 = new UnidadeMedidaEntity(1L, "Quilograma", "kg");
        UnidadeMedidaEntity u2 = new UnidadeMedidaEntity(2L, "Litro", null);
        UnidadeMedidaEntity u3 = new UnidadeMedidaEntity(3L, null, "ml");
        UnidadeMedidaEntity u4 = new UnidadeMedidaEntity(4L, null, null);
